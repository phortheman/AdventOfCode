...
#
#             rawData[(int(sensorX), int(sensorY))] = manhattanDistance(
#                 int(sensorX), int(sensorY), int(beaconX), int(beaconY)
#             )
#
...
#
#     part1Result = max(
#         sensor[0] - abs(part1Target - sensor[1]) + distance
...
#
#     print(
#         f"The number of position at {part1Target} that can't have a beacon is: {part1Result}"
#     )
#     print(
#         f"The tuning frequency is: {part2Result[distressX].as_long() * 4_000_000 + part2Result[distressY].as_long()}"
#     )
#
#
